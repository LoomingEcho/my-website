...
interface ViewportObserverData {
  ...
  callbackMap: WeakMap<HTMLElement, Array<IObserverCallback>>;
}
...
class ViewportObserverService {
  ...
  static removeCallback(callbacks: Array<IObserverCallback>, callback: IObserverCallback) {
  ...
  static callbackExists(callbacks: Array<IObserverCallback>, callback: IObserverCallback) {
    return (
      callbacks.find(cb => {
        return (
  ...
  observe(targetElement: HTMLElement, callback: IObserverCallback, observerConfig: IntersectionObserverInit = {}) {
  ...
  unobserve(targetElement: HTMLElement, callback: IObserverCallback, observerConfig: IntersectionObserverInit = {}) {
    const iObserverData = this.getIObserverData(observerConfig);
  ...
  fireCallbacks(callbacks: Array<IObserverCallback>, isIntersecting: boolean) {
